 ...
 */
var app = angular.module('core', ['ui.router', 'ui-notification', 'pascalprecht.translate', '720kb.datepicker', 'ngDialog', 'templates', 'ui.bootstrap', 'core.auth', 'core.dashboard']);

app.config(function ($translateProvider, TRANSLATES, $windowProvider, ResourcesServiceProvider) {
  var siteId = ResourcesServiceProvider.getSiteId();
  if (siteId) {
